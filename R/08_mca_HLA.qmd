...
None of the variables explain the variance in data enough, therefore there is no indication of a specific allele subtype which is able to conclude difference between case or control.
