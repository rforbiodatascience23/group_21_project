...
-   Missing data for control makes it difficult to determine significant differences between antibody expression for case and control
-   Results from PCA seems to suggest reducing dimensionality of data by clustering antibodies
-   No dimensionality reduction suggested from PCA on HLA
:::
