...
![](./../results/06_plot_3.png){.absolute right=300 bottom=10 width="850" height="500"}
![](./../results/06_plot_2.png){.absolute left=600 top=10 width="500" height="300"}
...
![](./../results/07_plot_1.png){width="500" rotate=90}
