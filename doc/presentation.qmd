...
![](./../results/04_plot_1.png){width="1150" height="550"}

![](./../results/04_plot_2.png){width="1150" height="550"}
...
![](./../results/05_plot_1.png){width="1150" height="550"}

------------------------------------------------------------------------

## Antibody Expression, PCA {.scrollable}

![](./../results/06_plot_3.png){width="1150" height="550"} 
![](./../results/06_plot_2.png){width="1150" height="550"}
...
![](./../results/08_plot_1.png){width="1150" height="550"}

![](./../results/08_plot_2.png){width="1150" height="550"}
